...
**networkformat** converts R objects into network edgelist/nodelist format for visualization and analysis with packages like igraph, tidygraph, and ggraph. It works with tree-based ML models (`randomForest`, `tree`, `rpart`, `xgboost`, `gbm`), data frames, and vectors.

Full documentation (pending) at <https://jesseabrandt.github.io/networkformat/>.

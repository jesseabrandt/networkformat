...
**networkformat** converts R objects into network edgelist/nodelist format for visualization and analysis with packages like igraph, tidygraph, and ggraph. It works with tree-based ML models (`randomForest`, `tree`), data frames, and vectors.
